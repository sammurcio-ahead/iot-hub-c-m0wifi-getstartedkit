...
***
**Note**: Arduino version 1.8.3 with WiFi101 does not support SSL connections on ports other than 443, so the MQTT protocol fails to connect. After this issue hase been fixed MQTT support will be available again.
